...
CREATE TABLE `tbl_case` (
  ...
  `phy_exam_count` int(11) NOT NULL,
  `fst_visit_count` int(11) NOT NULL,
  `ary_exam_count` int(11) NOT NULL,
  `diagnose_count` int(11) NOT NULL,
  `treatment_count` int(11) NOT NULL,
  `pat_man_count` int(11) NOT NULL,
  `inquiry_count` int(11) NOT NULL,
  PRIMARY KEY (`case_id`),
  UNIQUE KEY `id_case_UNIQUE` (`case_id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COMMENT='病历表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_case` VALUES (3,'<p>一例18岁男性患者,近一个月突然出现多尿,多饮,多食,体重下降5kg,空腹<br />\r\n<br />\r\n血糖13mmol/L(230mg/dl),血清胰岛细胞抗体阳性.</p>\r\n\r\n<p>dqw</p>\r\n','2017-05-02','rongyu',3,'A2','高血压',0,0,0,0,0,0,0),(4,'<pre>\r\n男性，35岁，稍长距离步行后感右小腿疼痛，肌肉抽搐跛行，稍休息后症状消失，平时感右足反凉，怕冷，有麻木感。右足背动脉搏动减弱</pre>\r\n','2017-05-02','rongyu',4,'A2','2',0,0,0,0,0,0,0),(5,'<p>A.血红蛋白电泳&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>\r\n\r\n<p>&nbsp;B.高铁血红蛋白还原试验<br />\r\n<br />\r\nC.红细胞脆性试验 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</p>\r\n\r\n<p>D.抗人球蛋白试验<br />\r\n<br />\r\nE.酸溶血试验</p>\r\n','2017-05-02','rongyu',3,'A2','3',0,0,0,0,0,0,0),(6,'<p>A.胃、十二指肠溃疡胃大部切除术&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;B.闭合性腹部创伤，腹腔穿刺有不凝血<br />\r\n<br />\r\nC.早期胃癌 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;D.急性胆囊炎<br />\r\n<br />\r\nE.单纯性急性胰腺炎</p>\r\n','2017-05-02','rongyu',4,'A3','4',0,0,0,0,0,0,0);
...
-- Dump completed on 2017-05-02 20:04:22
