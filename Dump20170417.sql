...
CREATE TABLE `tbl_accessory_exam` (
  ...
  KEY `ind_ae` (`case_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='辅助体检表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_case` VALUES (20,'千瓦·','请问·','2017-04-17','rongyu',1,'0,1,2');
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='确诊表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_first_visit` (
  ...
  KEY `ind_fv` (`case_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='初诊表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=114 DEFAULT CHARSET=utf8mb4 COMMENT='问诊表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_inquiry` VALUES (1,0,'你抽烟吗？','不，我不抽烟。',3,1,0),(2,0,'你喝酒吗？','不，我从不喝酒。',3,2,0),(6,0,'请问您主要是哪里不舒服？','腿脚不便',1,4,0),(10,0,'您是什么血型的？','不清楚，没检查过',2,4,0),(11,0,'您平时身体状况怎样？','挺好的',2,5,0),(112,20,'请问您主要是哪里不舒服？','腿脚不便',1,4,22),(113,20,'你抽烟吗？','不，我不抽烟。',3,1,2);
...
CREATE TABLE `tbl_patient_management` (
  ...
  KEY `ind_pm` (`case_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='患者管理表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tbl_physical_exam` (
  ...
  KEY `ind_pe` (`case_id`)
) ENGINE=InnoDB AUTO_INCREMENT=89 DEFAULT CHARSET=utf8 COMMENT='体检表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_physical_exam` VALUES (1,0,'脉率(次/分)','生命体征','71','1','1',0),(2,0,'血压(mmHg)','生命体征','131/68','1','2',0),(3,0,'体温(℃)','生命体征','36.9','1','3',0),(4,0,'呼吸频率(次/分)','生命体征','23','1','4',0),(5,0,'步态','一般情况','步态正常','2','5',0),(6,0,'面容','一般情况','面容正常','2','6',0),(7,0,'发育状况','一般情况','正常','2','7',0),(8,0,'体型','一般情况','正力型','2','8',0),(9,0,'浮肿状况','皮肤粘膜','无浮肿','3','9',0),(10,0,'肝掌标志','皮肤粘膜','无肝掌','3','10',0),(11,0,'溃疡','皮肤粘膜','无溃疡','3','11',0),(12,0,'皮肤检查','皮肤粘膜','正常','3','12',0),(13,0,'淋巴结检查','淋巴结','正常','4','13',0),(14,0,'浅表淋巴结检查','淋巴结','浅表淋巴结为触及肿大','4','14',0),(15,0,'头颅大小','头颈部','正常','5','15',0),(16,0,'头颅形态','头颈部','正常','5','16',0),(17,0,'桶状胸','胸','否','6','17',0),(18,0,'胸骨叩痛','胸','否','6','18',0),(19,0,'呼吸运动','肺','正常','7','19',0),(20,0,'语颤状况','肺','正常','7','20',0),(21,0,'胸膜摩擦感','肺','否','7','21',0),(22,0,'皮下捻发感','肺','否','7','22',0),(23,0,'肺部叩诊','肺','双肺叩诊呈清音','7','23',0),(24,0,'肺下界','肺','正常','7','24',0),(58,20,'头颅形态',NULL,'正常','5','16',1),(59,20,'浮肿状况',NULL,'无浮肿','3','9',22),(60,20,'肝掌标志',NULL,'无肝掌','3','10',3),(61,20,'肝掌标志',NULL,'无肝掌','3','10',3),(62,20,'浮肿状况',NULL,'无浮肿','3','9',22),(63,20,'肝掌标志',NULL,'无肝掌','3','10',3),(64,20,'肝掌标志',NULL,'无肝掌','3','10',3),(65,20,'溃疡',NULL,'无溃疡','3','11',0),(66,20,'肝掌标志',NULL,'无肝掌','3','10',3),(67,20,'肝掌标志',NULL,'无肝掌','3','10',3),(68,20,'溃疡',NULL,'无溃疡','3','11',0),(69,20,'溃疡',NULL,'无溃疡','3','11',0),(70,20,'溃疡',NULL,'无溃疡','3','11',0),(71,20,'头颅形态',NULL,'正常','5','16',1),(72,20,'头颅形态',NULL,'正常','5','16',1),(73,20,'头颅形态',NULL,'正常','5','16',1),(74,20,'头颅形态',NULL,'正常','5','16',1),(75,20,'头颅形态',NULL,'正常','5','16',1),(76,20,'头颅形态',NULL,'正常','5','16',1),(77,20,'头颅形态',NULL,'正常','5','16',1),(78,20,'头颅形态',NULL,'正常','5','16',1),(79,20,'头颅形态',NULL,'正常','5','16',1),(80,20,'头颅形态',NULL,'正常','5','16',1),(81,20,'头颅形态',NULL,'正常','5','16',1),(82,20,'头颅形态',NULL,'正常','5','16',1),(83,20,'头颅形态',NULL,'正常','5','16',1),(84,20,'头颅形态',NULL,'正常','5','16',1),(85,20,'头颅形态',NULL,'正常','5','16',1),(86,20,'头颅形态',NULL,'正常','5','16',1),(87,20,'肝掌标志',NULL,'无肝掌','3','10',3),(88,20,'肝掌标志',NULL,'无肝掌','3','10',3);
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='治疗表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-04-17 19:08:24
