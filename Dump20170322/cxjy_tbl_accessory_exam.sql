...
CREATE TABLE `tbl_accessory_exam` (
  ...
  `accessory_exam_result` varchar(45) DEFAULT NULL COMMENT '辅助体检结果',
  `accessory_exam_type` varchar(45) DEFAULT NULL COMMENT '辅助体检类型（区分文本、图片、音视频）',
  `accessory_exam_order` int(11) DEFAULT NULL,
  `score` double DEFAULT NULL COMMENT '分值',
  PRIMARY KEY (`accessory_exam_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='辅助体检表';
...
INSERT INTO `tbl_accessory_exam` VALUES (1,1,'脑部扫描','正常','1',1,5);
